...
# Besides simplifying the process into one step, DictVectorizer has useful attributes such as vocabulary_
# which maps the names of the features to their indices. With the data preprocessed, it's time to move onto pipelines!
------------------
...
randomized_roc_auc = RandomizedSearchCV(estimator=pipeline,
                                       ...
                                       n_iter=2, scoring='roc_auc',verbose=1,cv=2)
